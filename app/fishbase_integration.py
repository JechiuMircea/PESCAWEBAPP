    ...
    def download_fishbase_dataset(self, output_path: str = "fishbase_data.csv") -> bool:
        ...
        try:
            ...
            specie_estese = [
                ...
                {
                    "nome_comune": "Salmone",
                    "nome_scientifico": "Salmo salar",
                    "famiglia": "Salmonidae",
                    "habitat": "Mari e fiumi freddi",
                    "taglia_min": 50.0,
                    "taglia_max": 150.0,
                    "peso_max": 40.0,
                    "periodo_riproduzione": "Settembre-Novembre",
                ...
                {
                    "nome_comune": "Tinca",
                    "nome_scientifico": "Tinca tinca",
                    "famiglia": "Cyprinidae",
                    "habitat": "Laghi e stagni con vegetazione",
                    "taglia_min": 20.0,
                    "taglia_max": 70.0,
                    "peso_max": 8.0,
                    "periodo_riproduzione": "Maggio-Luglio",
                    "note": "Specie molto resistente, sopravvive in acque povere di ossigeno",
                },
                {
                    "nome_comune": "Scardola",
                    "nome_scientifico": "Scardinius erythrophthalmus",
                    "famiglia": "Cyprinidae",
                    "habitat": "Laghi e fiumi a corso lento",
                    "taglia_min": 15.0,
                    "taglia_max": 40.0,
                    "peso_max": 1.5,
                ...
                {
                    "nome_comune": "Persico Sole",
                    "nome_scientifico": "Lepomis gibbosus",
                ...
                {
                    "nome_comune": "Siluro",
                    "nome_scientifico": "Silurus glanis",
                    "famiglia": "Siluridae",
                    "habitat": "Fiumi e laghi grandi",
                    "taglia_min": 50.0,
                    "taglia_max": 300.0,
                    "peso_max": 150.0,
                    "periodo_riproduzione": "Maggio-Giugno",
                ...
                {
                    "nome_comune": "Storione",
                    "nome_scientifico": "Acipenser sturio",
                    "famiglia": "Acipenseridae",
                    "habitat": "Mari e fiumi",
                    "taglia_min": 100.0,
                    "taglia_max": 500.0,
                    "peso_max": 400.0,
                    "periodo_riproduzione": "Aprile-Maggio",
                ...
                {
                    "nome_comune": "Branzino",
                    "nome_scientifico": "Dicentrarchus labrax",
                    "famiglia": "Moronidae",
                    "habitat": "Mari e lagune costiere",
                    "taglia_min": 25.0,
                    "taglia_max": 100.0,
                    "peso_max": 12.0,
                    "periodo_riproduzione": "Dicembre-Marzo",
                    "note": "Specie molto apprezzata in cucina",
                },
                {
                    "nome_comune": "Orata",
                    "nome_scientifico": "Sparus aurata",
                    "famiglia": "Sparidae",
                    "habitat": "Mari e lagune costiere",
                    "taglia_min": 20.0,
                    "taglia_max": 70.0,
                ...
                {
                    "nome_comune": "Sgombro",
                    "nome_scientifico": "Scomber scombrus",
                    "famiglia": "Scombridae",
                    "habitat": "Mari aperti",
                    "taglia_min": 20.0,
                    "taglia_max": 50.0,
                ...
                {
                    "nome_comune": "Tonno",
                    "nome_scientifico": "Thunnus thynnus",
                    "famiglia": "Scombridae",
                    "habitat": "Mari aperti e profondi",
                    "taglia_min": 100.0,
                    "taglia_max": 400.0,
                    "peso_max": 600.0,
        ...
        try:
            ...
            for _, row in df.iterrows():
                try:
                    ...
                    logger.warning(
                        f"⚠️ Errore nell'inserimento di {row['nome_scientifico']}: {e}"
                    )
                    continue
