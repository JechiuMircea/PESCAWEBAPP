...
def verify_database_structure():
    ...
    try:
        ...
        for col in columns:
            ...
            print(
                f"  {name:8} | {type_name:6} | {nullable:8} | {str(default_value):7} | {pk_mark:11}"
            )
...
def verify_database_data():
    ...
    try:
        ...
        print("\n📝 ESEMPI DI SPECIE:")
        cursor.execute(
            "SELECT nome_comune, nome_scientifico, famiglia FROM specie_ittiche LIMIT 5"
        )
        ...
        cursor.execute(
            "SELECT COUNT(*) FROM specie_ittiche WHERE nome_scientifico IS NULL OR nome_scientifico = ''"
        )
...
def run_database_tests():
    ...
    try:
        ...
        try:
            ...
            cursor.execute(
                "SELECT COUNT(*) FROM specie_ittiche WHERE nome_scientifico = 'Testus fishus'"
            )
            ...
            if count > 0:
                ...
                cursor.execute(
                    "DELETE FROM specie_ittiche WHERE nome_scientifico = 'Testus fishus'"
                )
        ...
        try:
            ...
            cursor.execute(
                "SELECT note FROM specie_ittiche WHERE nome_scientifico = 'Salmo trutta'"
            )
        ...
        try:
            ...
            # Verifica inserimento
            cursor.execute(
                "SELECT COUNT(*) FROM identificazioni_specie WHERE immagine_url = 'test_image.jpg'"
            )
            count = cursor.fetchone()[0]
            ...
            if count > 0:
                ...
                cursor.execute(
                    "DELETE FROM identificazioni_specie WHERE immagine_url = 'test_image.jpg'"
                )
